...
const faqSchema = {
  ...
  "@type": "FAQPage", mainEntity: [
    { "@type": "Question", name: "What is included in your 3PL services?", acceptedAnswer: { "@type": "Answer", text: "Our integrated 3PL services include workforce management, warehousing & inventory management, transportation & fleet management, dedicated account management, and real-time analytics dashboard." } },
    { "@type": "Question", name: "How is 3PL different from hiring separate vendors?", acceptedAnswer: { "@type": "Answer", text: "With our 3PL, you get single-point accountability, one contract, one invoice, and a dedicated account manager — eliminating the overhead of coordinating multiple vendors and reducing logistics costs by up to 15%." } },
    { "@type": "Question", name: "Do you provide real-time visibility into operations?", acceptedAnswer: { "@type": "Answer", text: "Yes, our web dashboard provides live KPIs including inventory levels, workforce attendance, fleet tracking, and SLA performance reports — accessible anytime, anywhere." } },
    { "@type": "Question", name: "Which industries do you serve with 3PL?", acceptedAnswer: { "@type": "Answer", text: "We serve automotive, e-commerce, FMCG, pharmaceuticals, retail, and manufacturing sectors with tailored 3PL solutions." } },
  ],
};

export const metadata: Metadata = {
  title: "3PL Services India | Third Party Logistics | Sai Sree Logistics",
  description: "Integrated 3PL services in India — manpower, warehousing, and transportation under one roof. Dedicated account management, real-time analytics, and end-to-end supply chain solutions.",
  keywords: ["3PL services India", "third party logistics", "integrated logistics solutions", "supply chain management India", "3PL warehouse services", "logistics outsourcing"],
  openGraph: { title: "3PL Services India | Third Party Logistics | Sai Sree Logistics", description: "Integrated 3PL services — manpower, warehousing, and transportation under one roof. End-to-end supply chain solutions." },
};

export default function ThreePLServices() {
  return (
    <>
      <Script id="3pl-faq" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(faqSchema) }} />
      <div className="min-h-screen">
        <section className="relative pt-32 pb-20 sm:pt-40 sm:pb-28 overflow-hidden">
          ...
          <div className="relative mx-auto max-w-7xl px-6 lg:px-8 text-center">
            <span className="mb-4 inline-block text-[11px] font-semibold uppercase tracking-[0.25em] text-gold/70">Integrated 3PL Solutions</span>
            <h1 className="mb-6 text-4xl font-bold leading-tight sm:text-5xl lg:text-6xl">End-to-End 3PL Services <span className="text-gradient-gold">India</span></h1>
            <p className="mx-auto mb-8 max-w-3xl text-base leading-relaxed text-white/50 sm:text-lg">Sai Sree Logistics is your single-partner 3PL provider — combining workforce management, warehousing operations, and transportation into one seamlessly managed ecosystem with real-time analytics and dedicated account management. One contract, one partner, end-to-end visibility.</p>
        ...
        <section className="relative py-20">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <h2 className="mb-10 text-center text-3xl font-bold sm:text-4xl">What&apos;s Included in Our <span className="text-gradient-gold">3PL</span></h2>
        ...
        <section className="relative py-20">
          <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
            <h2 className="mb-6 text-2xl font-bold sm:text-3xl">One Partner. One Contract. End-to-End.</h2>
            <p className="mb-8 text-white/50">Simplify your supply chain with India&apos;s most integrated 3PL provider.</p>
