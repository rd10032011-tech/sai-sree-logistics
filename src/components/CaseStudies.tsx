      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <p className="mx-auto max-w-2xl text-sm sm:text-base text-white/40 leading-relaxed">
            Real engagements, measurable outcomes — how we solve complex workforce and logistics challenges.
          </p>
        </motion.div>
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="mt-auto grid grid-cols-2 gap-2">
                  {study.results.map((result) => (
                    <div
                      key={result}
                      className="rounded-lg border border-gold/[0.08] bg-gold/[0.03] px-3 py-2 text-center"
                    >
